...
import profileImage from "../../../assets/images/profile/profile006.jpg";
import coverImage from "../../../assets/images/covers/listenToWind.jpg";
        ...
        <View style={styles.rootWant}>
            ...
            <View style={styles.header}>
                ...
                <View style={{ display: 'flex' }}>
                    <View style={styles.headerDetail}>
                        <Button titleStyle={{ fontSize: 15 }} containerStyle={{ color: 'blue' }} title="Farshid" type="clear" />
                        <Text style={{marginRight:5}}>rated a book</Text>           
                         <Rating
                            type='custom'
                            ratingColor='#ff5656'
            ...
            <View style={styles.body}>
                ...
                <View style={{ marginLeft: 10, height: '90%', justifyContent: 'flex-start' }}>
                    <Text style={{ marginBottom: -7 }}>Listen to the Wind</Text>
                    <Button titleStyle={{ fontSize: 12, alignSelf: 'flex-start' }} containerStyle={{ marginBottom: 10, color: 'blue', alignSelf: 'flex-start' }} title="Haruki Murakami" type="clear" />
