...
import profileImage from "../../../assets/images/profile/profile01.jpg";
import coverImage from "../../../assets/images/covers/onePlusOne.jpg";
...
export default function Start() {
    return (
        <View style={styles.rootWant}>
            <View style={styles.header}>
                ...
                <View style={{display:'flex'}}>
                    <View style={styles.headerDetail}>
                        <Button titleStyle={{ fontSize: 15 }} containerStyle={{ color: 'blue' }} title="Shima" type="clear" />
                        <Text>starts reading</Text>
                    </View>
            ...
            <Text style={{marginBottom:-7}}>One Plus One</Text>
            <Button titleStyle={{ fontSize: 12, alignSelf:'flex-start' }} containerStyle={{marginBottom:10, color: 'blue', alignSelf:'flex-start' }} title="Jojo Moyez" type="clear"/>
